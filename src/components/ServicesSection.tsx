...
const services = [
  ...
  },
  {
    ...
    checks: ["Практически упражнения", "Издаване на удостоверения"],
  },
  {
    icon: Scale,
    title: "Консултации пред РСПБЗН",
    desc: "Представителство и консултации при проверки от органите по пожарна безопасност и защита на населението.",
    checks: ["Подготовка на документи", "Присъствие при проверка"],
  },
];
