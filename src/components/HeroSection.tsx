...
const features = [
  {
    icon: ShieldCheck,
    title: "Сертификация",
    desc: "Разполагаме с всички необходими удостоверения и разрешителни от РЗПБЗН – доказателство, че нашите услуги отговарят на най-високите български и европейски стандарти за безопасност.",
  },
  {
    icon: Truck,
    title: "Мобилен сервиз",
    desc: "Извършваме оглед, поддръжка и ремонт на пожароизвестителни системи, пожарогасене и огледи за проектиране директно на Вашия обект. За пожарогасителите осигуряваме бърз транспорт до нашия сервиз и обратно – поемаме грижата за логистиката, Вие пестите време.",
  },
  {
    icon: Clock,
    title: "Бързина и точност",
    desc: "Държим на срокове, но знаем, че качеството не се измерва само в часове. За малки и средни обекти реагираме в рамките на 48 часа. За по-големи обеми – изготвяме реален график, съобразен с обема на работата, без компромис с прецизността. Вярваме, че надеждността не бърза, но никога не закъснява.",
  },
];
