      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            <strong className="text-foreground">ВАТО Пожарна Безопасност ООД</strong> е лицензирана фирма по чл. 129, ал. 2 от ЗМВР, специализирана в областта на пожарната безопасност и защита на обекти от всякакъв мащаб.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
            Основана през 2009 г. в гр. Варна, компанията предоставя пълен спектър от услуги — от техническо обслужване на пожарогасители, проектиране, <strong className="text-foreground">изграждане</strong> и обслужване на пожароизвестителни системи до провеждане на обучения и представителство пред РСПБЗН.
          </p>
